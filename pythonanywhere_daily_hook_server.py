#!/usr/bin/env python3
"""
PythonAnywhere Daily Scheduler Hook - Server Version

This version is specifically configured for PythonAnywhere deployment
where files are located directly in /home/ferrous77/
"""
...
# PythonAnywhere specific setup - files are in /home/ferrous77/
script_dir = Path("/home/ferrous77")
os.chdir(script_dir)

# Add src to Python path for PythonAnywhere
